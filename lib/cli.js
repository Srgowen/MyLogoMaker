...
function CLI() {
    inquirer.prompt([
        ...
        },
        {
            type: "input",
            name: "text",
            message: "What text would you like inside your logo? (must be no more than 3 characters)",
            validate: (response) => response.length <= 3 || "You can only input 3 or fewer characters."
        },
        {
            type: "input",
            name: "textColor",
...
function generateSVG(newShape, text, textColor) {
    return `<svg width="550" height="500" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ${newShape.render()} 
